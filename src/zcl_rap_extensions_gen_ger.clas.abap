CLASS zcl_rap_extensions_gen_ger DEFINITION
INHERITING FROM zcl_rap_extensions_base_ger
  PUBLIC
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
    ...
    CONSTANTS:
      ...
      co_suffix                     TYPE string           VALUE 'GER',
...
CLASS zcl_rap_extensions_gen_ger IMPLEMENTATION.
